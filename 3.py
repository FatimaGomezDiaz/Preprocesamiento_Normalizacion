...
def normalizar_escalado_simple_acuario(acuario_df, columnas_a_normalizar):
...
acuario_normalizado = normalizar_escalado_simple_acuario(acuario_df, ['temperatura', 'ph_agua'])
